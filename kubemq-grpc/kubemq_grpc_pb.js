...
var kubemq_pb = require('./kubemq_pb.js');

function serialize_kubemq_AckAllQueueMessagesRequest(arg) {
  if (!(arg instanceof kubemq_pb.AckAllQueueMessagesRequest)) {
...
function deserialize_kubemq_AckAllQueueMessagesRequest(buffer_arg) {
  return kubemq_pb.AckAllQueueMessagesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_AckAllQueueMessagesResponse(arg) {
  if (!(arg instanceof kubemq_pb.AckAllQueueMessagesResponse)) {
...
function deserialize_kubemq_AckAllQueueMessagesResponse(buffer_arg) {
  return kubemq_pb.AckAllQueueMessagesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Empty(arg) {
  if (!(arg instanceof kubemq_pb.Empty)) {
...
function deserialize_kubemq_Empty(buffer_arg) {
  return kubemq_pb.Empty.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Event(arg) {
  if (!(arg instanceof kubemq_pb.Event)) {
...
function deserialize_kubemq_Event(buffer_arg) {
  return kubemq_pb.Event.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_EventReceive(arg) {
  if (!(arg instanceof kubemq_pb.EventReceive)) {
...
function deserialize_kubemq_EventReceive(buffer_arg) {
  return kubemq_pb.EventReceive.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_PingResult(arg) {
  if (!(arg instanceof kubemq_pb.PingResult)) {
...
function deserialize_kubemq_PingResult(buffer_arg) {
  return kubemq_pb.PingResult.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_QueueMessage(arg) {
  if (!(arg instanceof kubemq_pb.QueueMessage)) {
...
function deserialize_kubemq_QueueMessage(buffer_arg) {
  return kubemq_pb.QueueMessage.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_QueueMessagesBatchRequest(arg) {
  if (!(arg instanceof kubemq_pb.QueueMessagesBatchRequest)) {
...
function deserialize_kubemq_QueueMessagesBatchRequest(buffer_arg) {
  return kubemq_pb.QueueMessagesBatchRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_QueueMessagesBatchResponse(arg) {
  if (!(arg instanceof kubemq_pb.QueueMessagesBatchResponse)) {
...
function deserialize_kubemq_QueueMessagesBatchResponse(buffer_arg) {
  return kubemq_pb.QueueMessagesBatchResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_ReceiveQueueMessagesRequest(arg) {
  if (!(arg instanceof kubemq_pb.ReceiveQueueMessagesRequest)) {
...
function deserialize_kubemq_ReceiveQueueMessagesRequest(buffer_arg) {
  return kubemq_pb.ReceiveQueueMessagesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_ReceiveQueueMessagesResponse(arg) {
  if (!(arg instanceof kubemq_pb.ReceiveQueueMessagesResponse)) {
...
function deserialize_kubemq_ReceiveQueueMessagesResponse(buffer_arg) {
  return kubemq_pb.ReceiveQueueMessagesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Request(arg) {
  if (!(arg instanceof kubemq_pb.Request)) {
...
function deserialize_kubemq_Request(buffer_arg) {
  return kubemq_pb.Request.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Response(arg) {
  if (!(arg instanceof kubemq_pb.Response)) {
...
function deserialize_kubemq_Response(buffer_arg) {
  return kubemq_pb.Response.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Result(arg) {
  if (!(arg instanceof kubemq_pb.Result)) {
...
function deserialize_kubemq_Result(buffer_arg) {
  return kubemq_pb.Result.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_SendQueueMessageResult(arg) {
  if (!(arg instanceof kubemq_pb.SendQueueMessageResult)) {
...
function deserialize_kubemq_SendQueueMessageResult(buffer_arg) {
  return kubemq_pb.SendQueueMessageResult.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_StreamQueueMessagesRequest(arg) {
  if (!(arg instanceof kubemq_pb.StreamQueueMessagesRequest)) {
...
function deserialize_kubemq_StreamQueueMessagesRequest(buffer_arg) {
  return kubemq_pb.StreamQueueMessagesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_StreamQueueMessagesResponse(arg) {
  if (!(arg instanceof kubemq_pb.StreamQueueMessagesResponse)) {
...
function deserialize_kubemq_StreamQueueMessagesResponse(buffer_arg) {
  return kubemq_pb.StreamQueueMessagesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_kubemq_Subscribe(arg) {
  if (!(arg instanceof kubemq_pb.Subscribe)) {
...
function deserialize_kubemq_Subscribe(buffer_arg) {
  return kubemq_pb.Subscribe.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var kubemqService = exports.kubemqService = {
  sendEvent: {
    ...
    requestType: kubemq_pb.Event,
    responseType: kubemq_pb.Result,
  ...
  subscribeToEvents: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: kubemq_pb.Subscribe,
    responseType: kubemq_pb.EventReceive,
  ...
  subscribeToRequests: {
    ...
    responseStream: true,
    requestType: kubemq_pb.Subscribe,
    responseType: kubemq_pb.Request,
    requestSerialize: serialize_kubemq_Subscribe,
    requestDeserialize: deserialize_kubemq_Subscribe,
  ...
  sendRequest: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.Request,
    responseType: kubemq_pb.Response,
  ...
  sendResponse: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.Response,
    responseType: kubemq_pb.Empty,
  ...
  sendQueueMessage: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.QueueMessage,
    responseType: kubemq_pb.SendQueueMessageResult,
  ...
  sendQueueMessagesBatch: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.QueueMessagesBatchRequest,
    responseType: kubemq_pb.QueueMessagesBatchResponse,
  ...
  receiveQueueMessages: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.ReceiveQueueMessagesRequest,
    responseType: kubemq_pb.ReceiveQueueMessagesResponse,
  ...
  streamQueueMessage: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: kubemq_pb.StreamQueueMessagesRequest,
    responseType: kubemq_pb.StreamQueueMessagesResponse,
  ...
  ackAllQueueMessages: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.AckAllQueueMessagesRequest,
    responseType: kubemq_pb.AckAllQueueMessagesResponse,
  ...
  ping: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kubemq_pb.Empty,
    responseType: kubemq_pb.PingResult,
